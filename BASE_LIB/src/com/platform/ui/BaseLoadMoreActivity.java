 ...
 */
public abstract class BaseLoadMoreActivity<T extends BaseContract.Presenter> extends BaseFragmentActivity<T> implements ReloadListener,RefreshLoadMoreListView.LoadMoreListener {
    ...
    public void initView(Boolean autoRequest, boolean withFooter) {
        mRefreshView = (RefreshLoadMoreListView) findViewById(R.id.v_refresh);
