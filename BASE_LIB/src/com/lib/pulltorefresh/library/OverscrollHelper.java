...
import com.lib.pulltorefresh.library.PullToRefreshBase.State;
			...
			if (mode.permitsPullToRefresh() && !isTouchEvent && deltaValue != 0) {
				...
				if (newScrollValue < (0 - fuzzyThreshold)) {
					...
					if (mode.showHeaderLoadingLayout()) {
						...
						Log.d(LOG_TAG, "overScrollBy; " + ((int) (scaleFactor * (currentScrollValue + newScrollValue))));
					...
					if (mode.showFooterLoadingLayout()) {
						...
						Log.d(LOG_TAG, " -- overScrollBy; " + (int)(scaleFactor * (currentScrollValue + newScrollValue - scrollRange)));
